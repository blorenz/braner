...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cmsplugin_videogalleryplugin', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('template', self.gf('django.db.models.fields.CharField')(default='cmsplugin_video_gallery/gallery.html', max_length=255)),
        ))
        db.send_create_signal(u'cmsplugin_video_gallery', ['VideoGalleryPlugin'])

        # Adding model 'Video'
        db.create_table(u'cmsplugin_video_gallery_video', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('inline_ordering_position', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('gallery', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cmsplugin_video_gallery.VideoGalleryPlugin'])),
            ...
            ('extended_content', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('mp4_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('ogv_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('webm_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('video_width', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
            ('video_height', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'cmsplugin_video_gallery', ['Video'])


    def backwards(self, orm):
        # Deleting model 'VideoGalleryPlugin'
        db.delete_table(u'cmsplugin_videogalleryplugin')

        # Deleting model 'Video'
        db.delete_table(u'cmsplugin_video_gallery_video')
