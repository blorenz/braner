...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Video.extended_content'
        db.alter_column(u'cmsplugin_video_gallery_video', 'extended_content', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Video.title'
        db.alter_column(u'cmsplugin_video_gallery_video', 'title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Video.link'
        db.alter_column(u'cmsplugin_video_gallery_video', 'link', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Video.alt'
        db.alter_column(u'cmsplugin_video_gallery_video', 'alt', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Video.extended_content'
        db.alter_column(u'cmsplugin_video_gallery_video', 'extended_content', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Video.title'
        db.alter_column(u'cmsplugin_video_gallery_video', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Video.link'
        db.alter_column(u'cmsplugin_video_gallery_video', 'link', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Video.alt'
        db.alter_column(u'cmsplugin_video_gallery_video', 'alt', self.gf('django.db.models.fields.TextField')(default=''))
    ...
    models = {
        ...
        u'cmsplugin_video_gallery.video': {
            ...
            'poster_src': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'poster_src_height': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'poster_src_width': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
